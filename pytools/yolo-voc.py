...
yolo_file = r'C:\Users\PC\Desktop\pytools\data\VOC\Annotations'  # yolo格式下的存放txt标注文件的文件夹
turn_xml_file = r'C:\Users\PC\Desktop\pytools\VOC-1\labels\train'  # 转换后储存xml的文件夹地址
img_file = r'D:/yolov5-5.0/runs/detect/exp3'  # 存放图片的文件夹

labels = ['armor_red', 'armor_blue', 'armor_grey','car_red','car_blue','car_unknow','watcher_red','watcher_blue','watcher_unknow']
